...
function SignInContent() {
        ...
        <div className="w-full max-w-md space-y-8 rounded-lg bg-white p-8 shadow-md">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              Please choose a unique UserID for your account
            </p>
          </div>
          ...
          <form onSubmit={handleUserIDSubmit} className="space-y-4">
            ...
            >
              {loading ? 'Registering...' : 'Register UserID'}
            </button>
          </form>
        </div>
      </div>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      <div className="w-full max-w-md space-y-8 rounded-lg bg-white p-8 shadow-md">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Welcome to heya</h1>
          <p className="mt-2 text-sm text-gray-600">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full rounded-md border border-gray-300 bg-gray-900 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-800"
          >
            <span className="flex items-center justify-center">
          ...
          <button
            ...
            className="w-full rounded-md border border-gray-300 bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700"
          >
            <span className="flex items-center justify-center">
              <svg className="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
